...
const InProgressCard: React.FC<InProgressCardProps> = ({ id, tasks }) => {
    ...
    <Box className="w-full p-4 bg-white shadow-md rounded-lg">
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography
            variant="h6"
            sx={{ backgroundColor: "#85D9F1", padding: 1, borderRadius: 1 }}
          >
            In-Progress ({tasksList?.length})
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
